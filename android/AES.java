...
public class AES {
     ...
     */
    private static final String secretKey = "2020748713735726";
    /**
     * AES 加密
     *
     * @param data      待加密内容
     ...
     * @return 加密后的文件
     */
    public File encryptFile(File sourceFile, String dir, String toFileName, String secretKey) {
        try {
            // 创建加密后的文件
     ...
     * @param secretKey  密钥
     */
    public File decryptFile(File sourceFile, String dir, String toFileName, String secretKey) {
        try {
            // 创建解密文件
     ...
     * @return 密钥
     */
    private Cipher initFileAESCipher(String secretKey, int cipherMode) {
        try {
            // 创建密钥规格
